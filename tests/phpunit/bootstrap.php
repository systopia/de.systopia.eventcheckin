...
// Make CRM_Eventcheckin_ExtensionUtil available.
require_once __DIR__ . '/../../eventcheckin.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.eventcheckin');
 ...
 */
function _eventcheckin_test_civicrm_container(ContainerBuilder $container): void {
}
